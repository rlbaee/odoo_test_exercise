...
Task 1 is in task1.py file in the root directory of the project. Writing the code for it was pretty easy, although coming up with the correct solution before writing the code, was the hard part for me

To test it, just run python task1.py. I used Python 3.10. You can also change search_domain variable and it should (i sure hope so) work.

### Task 2

This one was hard for me. Particularly because I've never developed anything for Odoo until this task. I used alot of AI for this one, but I can proudly say that I understand how it works now, and I believe I could replicate another module or an extension for a module in a much quicker timeframe than that.
